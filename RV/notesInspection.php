                ...
                <div class="layer-text">
                  <div class="page-left-2">
                    ...
                    <div class="page-text w-richtext">
                      <br>
                      <h3 class = "h3bum"><strong>REQUIREMENT REVIEW</strong></h3>
                      
                      <hr style="height:0.5px;border-width:0;color:gray;background-color:gray">
                      <hr  style="height:3px;border-width:0;color:gray;background-color:gray">
                    
                      <h6><b>* </b><a href="notesInspection.php" target="_blank">Review Inspection</a><b> *</b></h6>
                     
                      <h6><b>* </b><a href="notesWalkthrough.php" target="_blank">Walkthrough</a><b> *</b></h6>
                                        
                      <h6><b>* </b><a href="notesAudit.php" target="_blank">Audit/Commenting</a><b> *</b></h6>
                      
                      <h6><b>* </b><a href="notesInformal.php" target="_blank">Informal Review</a><b> *</b></h6>
                      <hr  style="height:3px;border-width:0;color:gray;background-color:gray">
                      <hr style="height:0.5px;border-width:0;color:gray;background-color:gray">
                      <p>‍</p>
                ...
                <div class="layer-text right">
                  <div class="page-right-2">
                    <div class="page-text w-richtext">
                      ...
                      <h6 id="titledo">REVIEW INSPECTION</h6>
                     
                      <dl>
                        <dt><b>Planning by organizer</b>
                      </dt>
                        <dd>*Prepare goal of inspection,work to be inspected and the roles during inspection.
                      </dd>
                      
                        <dt><b>Overview by moderator</b>
                      </dt>
                        <dd>*Get common understanding about requirements among inspectors.</dd>
                        
                        <dt><b>Error detection</b>
                      </dt>
                        <dd>*Inspectors need to search for error in the requirements while performing individually or in a team. 
                      </dd>
                                          
                      <dt><b>Inspection meeting</b>
                      </dt>
                       <br>
                       <dt><b>Making decision</b>
                      
                      </dt>
                        <dd>* Accept (With or without update)
                      
                      </dd>
                      <dd>* Reject (Update is compulsory while re-review is mandatory)
                      
                      </dd>
                      
                      
                       <dt><b>Rework & revision</b>
                      </dt>
                        
                      </dl>

                      <h6 id = "conduct"><a href="inspectionPlanning.php" target="_blank"><i>*conduct technique*</i></a></h6>
                       </p>
                    </div>
                  </div>
                </div>
