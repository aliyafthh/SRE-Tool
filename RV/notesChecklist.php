                ...
                <div class="layer-text">
                  <div class="page-left-2">
                    ...
                    <div class="page-text w-richtext">
                      <br>
                      <h3 class = "h3bum"><strong>CHECKLIST</strong></h3>
                      
                      <hr style="height:0.5px;border-width:0;color:gray;background-color:gray">
                      <hr  style="height:3px;border-width:0;color:gray;background-color:gray">
                    
                      <dl>
                        <dt><b>A checklist should comprise few questions so that the reviewer can use it during the validation in an effective way.</b><br><br>
                        *Applicable with each validation technique. <br><br>
                        *Create different checklists for different validation goals.<br><br>
                        *Create checklists based on rules,experience & defect statistics.
                      </dt>
                      <br>
                  ...
                  <div class="page-right-2">
                    <div class="page-text w-richtext">
                      ...
                      <dt><b>Critical Success Factors :</b>
                        ...
                        <dd>*Considering the stakeholders' background & experience</dd>
                        <dd>*Avoid generic questions such as <br>&nbsp;&nbsp;&nbsp;<i>"Are the requirements complete?"</i></dd>
                        <dd>*Limiting the size of checklist</dd>
                    
                        <dt><b>Benefit :</b>
                      </dt>
                      <dd>*Each reviewer knows how to check the artefact
                      </dd>
                        <dd>*Used for validation & for elicitation
                      </dd>
<br><br><br>
                      
                     </dl>
                      <!-- <h4><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;..............</strong></h4> -->
                      <h6 id = "conduct"><a href="checklist.php" target="_blank"><i>*conduct technique*</i></a></h6>
