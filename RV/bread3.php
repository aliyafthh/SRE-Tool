                  ...
                  Logout
																						...
																						<div class="container-fluid">
																							...
																							<div class="card shadow mb-4">
																									...
																									<nav aria-label="breadcrumb">
																										<ol class="breadcrumb breadcrumb-arrow p-0">
																											...
																											<li class="breadcrumb-item">
																												<a href="bread.php" class="text-uppercase pl-3">First Quality Aspect</a>
																											</li>
                                                                                                            <li class="breadcrumb-item pl-0">
																												<a href="bread2.php" class="text-uppercase">Second Quality Aspect</a>
																											</li>
                                                                                                            <li aria-current="page" class="breadcrumb-item pl-0 active text-uppercase pl-4">Third Quality Aspect</li>
																										</ol>
																									</nav>
																									<br>
																										<h5 class="text-muted">Validating the Agreement</h5>
																											...
																											<div class="card border-0">
																												<div class="card-header p-0 border-0" id="heading-239">
																													<button class="btn btn-link accordion-title border-0 collapse" data-toggle="collapse" data-target="#collapse-239" aria-expanded="true" aria-controls="#collapse-239">
																														<i class="fas fa-minus text-center d-flex align-items-center justify-content-center h-100"></i>Agreed 
																													</button>
																												</div>
																												<div id="collapse-239" class="collapse show" aria-labelledby="heading-239" data-parent="#accordion">
																													<div class="card-body accordion-body">
																														<p>
																															<b>Is every requirements agreed by all relevant stakeholders?
																														...
																														<br>
																															<hr>
																																<form class="form">
																																	<h6>
																																		<i>
																																			<strong>Got this Quality Criteria?</strong>
																																		</i>
																																	</h6>
																													...
																													<div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
																														<div class="card-header p-0 border-0" id="heading-240">
																															<button class="btn btn-link accordion-title border-0 collapsed" data-toggle="collapse" data-target="#collapse-240" aria-expanded="false" aria-controls="#collapse-240">
																																<i class="fas fa-minus text-center d-flex align-items-center justify-content-center h-100"></i>Agreed after changes                        
																															</button>
																														</div>
																														<div id="collapse-240" class="collapse " aria-labelledby="heading-240" data-parent="#accordion">
																															<div class="card-body accordion-body">
																																<p>
                                                                                                                                <b>Is every requirements agreed by all relevant stakeholders even after it has been changed?</b>
																																...
																																<div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
																																	<div class="card-header p-0 border-0" id="heading-241">
																																		<button class="btn btn-link accordion-title border-0 collapsed" data-toggle="collapse" data-target="#collapse-241" aria-expanded="false" aria-controls="#collapse-241">
																																			<i class="fas fa-minus text-center d-flex align-items-center justify-content-center h-100"></i>Resolved conflicts                        
																																		</button>
																																	</div>
																																	<div id="collapse-241" class="collapse " aria-labelledby="heading-241" data-parent="#accordion">
																																		<div class="card-body accordion-body">
																																			<p>
                                                                                                                                            <b>Have all known conflicts about requirements been resolved?</b>
                                                                                              ...
                                                                                              <br>
                                                                                              <form action = previewc3.php>
                                                                                              <button type="submit" name="update" value = "submit"  class="btn btn-primary btn btn-block" style='width:200px;margin:0 50%;position:relative;left:-14em;'> Save </button>
                                                                                              </form>
																																														</div>
																																													</div>
