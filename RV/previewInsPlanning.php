        ...
        <div class="container-fluid">
          ...
          <nav aria-label="breadcrumb">
              ...
              <li aria-current="page" class="breadcrumb-item pl-0 active text-uppercase pl-4">Planning</li>
                <li class="breadcrumb-item"><a href="previewInsError.php" class="text-uppercase pl-3">Error Detection</a></li>
            ...
            <br>
                ...
                <h2>Inspection<b> Planning</b></h2>
              </div>
              <div  class="col-sm-6">
                <a style="float:right; color:green" onclick="window.location.href='inspectionPlanning.php';" class="btn" data-toggle="modal"><i class="fas fa-plus-circle"></i><span>  Add New</span></a>
              </div>
                    </div>
                </div>
                <br>
               ...
               <?php
                ...
                $query = "SELECT * FROM inspection1";
                $query_run = mysqli_query($connection, $query);
               ?>
                <table style = "font-size:18px;" class="table  hoverTable">
                    <thead>
                        <tr>
                <th>
                ...
                <td>
                            ...
                            <div id = "insstart">
                               <td>  <?php echo $row['insstart']; ?></td> 
                            </div>

                            <div id = "insend">
                               <td>  <?php echo $row['insend']; ?></td> 
                            </div>
                            ...
                            <!-- <td> -->
                              <form action="previewInspectionPlanning.php" method="post">
