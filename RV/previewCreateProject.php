        ...
        <div class="container-fluid">
          <div class="card shadow mb-4" style="background-color:rgba(255, 255, 255, 0.95)">
            ...
            ?>
                ...
                <br>
                <h2 style="text-align:center; color:#0e817b"><b>Project Title : <?php echo $row['projectname']; ?></b></h2>
                
                <br>
                <hr>
                <h5 style= "color:#0e817b"><b>Project Description</b></h5></p>
                <hr>
                <h6 style="text-align:justify; "><?php echo $row['projectdesc']; ?></h6>
                <br>

                <hr>
                <h5 style= "color:#0e817b"><b>Group Leader</b></h5></p>
                <hr>
                <h6><?php echo $row['username']; ?> [ <?php echo $row['role1' ]; ?> ]</h6>
                <br>
            ...
            ?>
              ...
              <?php
                ...
                $sql = "SELECT * FROM createproject INNER JOIN register ON createproject.groupmember2 = register.studentid ";
            ...
            ?>
                ...
                <hr>
                <h6>1. <?php echo $row['username']; ?> [ <?php echo $row['role2']; ?> ]</h6>
            ...
            <?php
                ...
                $sql = "SELECT * FROM createproject INNER JOIN register ON createproject.groupmember3 = register.studentid ";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
            ?>
                <h6>2. <?php echo $row['username']; ?> [ <?php echo $row['role3']; ?> ] </h6>
            ...
            <?php
                ...
                $sql = "SELECT * FROM createproject INNER JOIN register ON createproject.groupmember4 = register.studentid ";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
            ?>
                <h6>3. <?php echo $row['username']; ?> [ <?php echo $row['role4']; ?> ]</h6>
            ...
            <?php
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while($row = mysqli_fetch_assoc($result)) {
            ?>
                <h6>4. <?php echo $row['username']; ?> [ <?php echo $row['role5']; ?> ]</h6>
