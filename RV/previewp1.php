          ...
          <div class="card shadow mb-4" style="background-color:rgba(255, 255, 255, 0.95)">
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                <h2>Principle 1:<b> The stakeholders</b></h2>
              </div>
              <div class="col-sm-6">
                <a onclick="window.location.href='addp1.php';" class="btn btn-success text-light" style = "float:right" data-toggle="modal"><i class="material-icons "  >&#xE147;</i> <span>Add New</span></a>
               ...
               ?>
                <table style = "font-size : 18px" class="table table-striped table-hover ">
                    <thead>
                        <tr>
                <th>
