...
$db = mysqli_select_db($connection, 'sretool');
    ...
    $query = "INSERT INTO rvp2(requirement,error,foundby,fdate,supportby,sdate) VALUES ('".$_POST["requirement"]."','".$_POST["error"]."','".$_POST["foundby"]."','".$_POST["fdate"]."','".$_POST["supportby"]."','".$_POST["sdate"]."')";
    ...
    if($requirement !=''&& $error !=''&& $foundby !=''&& $supportby !='')
{
        ...
        <div class="container-fluid">
          <div class="card shadow mb-4" style="background-color:rgba(255, 255, 255, 0.95)">
            <div class="card-body shadow-sm p-5">
              <h3 class="text-muted">
                <h2>PRINCIPLE 2 : ERROR IDENTIFICATION </h2>
                <br>
                <!-- <h1 class="h3 mb-4 text-gray-800"><strong>PRINCIPLE 1: INVOLVEMENT OF THE CORRECT STAKEHOLDERS</strong>
            </h1> -->
          
            <div style="background: #C3FCF2" class="jumbotron" >
              <div class="container">

              <form class = "user" action="addp2.php" id="my-form" method ="post"> 
                   <br>
              
                  <select name = "requirement" id = "requirement" class="custom-select mb-3">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control " rows="7" name = "error" id="errorF" placeholder="Any error(s)..."></textarea>
                  </div>
  
                <div class="form-row">
                  <div class="form-group col-md-8">
                    <label for="foundName"></label>
                    <input type="Name" name = "foundby" class="form-control" id="foundd" placeholder="Found by :" >
                  </div>
                  <div class="form-group col">
                    <label for="foundDate"></label>
                    <input type="date" name = "fdate" class="form-control" id="DateFoundd" placeholder="Date :">
                  </div>
                </div>                
                ...
                <div class="form-row">
                  <div class="form-group col-md-8">
                    ...
                    <input type="Name" name = "supportby" class="form-control" id="sapotBy" placeholder="Support by :" >
                  </div>
                  <div class="form-group col">
                    <label for="supportDate"></label>
                    <input type="date" name = "sdate" class="form-control" id="sDate" placeholder="Date :">
                  </div>
                </div>    
