      ...
      <div id="content">
        ...
        <div class="container">
            <div class="table-wrapper">
              ...
              <div class="col-sm-6">
                <a onclick="window.location.href='addp2.php';" class="btn btn-success text-light" style = "float:right" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New</span></a>
