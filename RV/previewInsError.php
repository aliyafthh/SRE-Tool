        ...
        <div class="container-fluid">
          ...
          <nav aria-label="breadcrumb">
            ...
            <br>
                ...
                <h2>Inspection<b> Error Detection</b></h2>
              </div>
              <div  class="col-sm-6">
                <a style="float:right; color:green" onclick="window.location.href='inspectionError.php';" class="btn" data-toggle="modal"><i class="fas fa-plus-circle"></i><span>  Add New</span></a>
              </div>
                    </div>
                </div>
                <br>
               ...
               ?>
                ...
                <td>
                           ...
                           <!-- <td> -->
                              <form action="previewInspectionError.php" method="post">
