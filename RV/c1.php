...
<body id="page-top">
 ...
 <li class="nav-item">
  ...
  <h1 id = "head1" >Requirement Checklist</h1>
  <div class="itemss">
    <input id="item1" type="checkbox" checked>
    <label for="item1">Atomic</label>

    <input id="item2" type="checkbox">
    <label for="item2">Correct</label>

    <input id="item3" type="checkbox">
    <label for="item3">Complete</label>

    <input id="item4" type="checkbox">
    <label for="item4">Consistent</label>

    <input id="item5" type="checkbox">
    <label for="item5">Comprehensible</label>

    <input id="item6" type="checkbox">
    <label for="item6">Feasible</label>

    <input id="item7" type="checkbox" checked>
    <label for="item7">Identifiable</label>

    <input id="item8" type="checkbox">
    <label for="item8">Necessary</label>

    <input id="item9" type="checkbox">
    <label for="item9">Rated</label>

    <input id="item10" type="checkbox">
    <label for="item10">Traceable</label>

    <input id="item11" type="checkbox">
    <label for="item11">Unambiguos</label>

    <input id="item12" type="checkbox">
    <label for="item12">Verifiable</label>

    <h2 class="done" aria-hidden="true" >Got it !</h2>
    <h2 class="undone" aria-hidden="true">No, we don't . . .</h2>
  </div>
</div>

</div>
                <!-- jangan usik 2 /div ni k -->
        </div>
        <!-- /.container-fluid -->
