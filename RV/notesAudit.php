                ...
                <div class="layer-text right">
                  <div class="page-right-2">
                    <div class="page-text w-richtext">
                      ...
                      <h6 id="titledo">AUDIT / COMMENTING</h6>
                     
                      <dl>
                        <dt><b>The author of a requirement artefact distributes the artefact to a set of stakeholders.</b> 
                      </dt>
<br>
                      <dt>*The stakeholders will check it individually and need to report the identified defects to the author. 
                      </dt>   
                      <br>
                      <dt>*The collected issues are discussed in a group session.
                      </dt>                
                       
                      <br>
                        <dt><b>Critical Success Factors :</b>
                      </dt>
                        <dd>*Commitment of the participants.
                      </dd>

                      <dd>*Coverage of all aspects.</dd>
       
                      <dt><b>Benefit :</b>
                      </dt>
                        <dd>*Obtain feedback from individual reviewers.</dd>
                        
                      </dl>

                      <!-- <h6 id = "conduct"><a href="https://www.poetryfoundation.org/poets/walt-whitman" target="_blank"><i>*conduct technique*</i></a></h6> -->
                       
                    </div>
                  </div>
                </div>
