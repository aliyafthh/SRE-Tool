...
<html lang="en">
	<head>
		...
		<div class="col-md-6">
		<form action = bread3.php>
         	<button type="submit" name="update" value = "submit"  class="btn btn-primary btn btn-block" style='width:100px;margin:0 50%;position:relative;left:39.5em;'> Edit </button>
        </form>
		</div> 
        ...
        <br>
							<table class="table table-striped"> 
								<thead> 
									<tr> 
										<th>Agreed</th> 
										<th>Agreed after changes</th> 
										<th>Resolved conflicts</th> 
