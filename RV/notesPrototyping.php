                ...
                <div class="layer-text">
                  <div class="page-left-2">
                    ...
                    <div class="page-text w-richtext">
                      <br>
                      <h3 class = "h3bum"><strong>PROTOTYPING</strong></h3>
                      
                      <hr style="height:0.5px;border-width:0;color:gray;background-color:gray">
                      <hr  style="height:3px;border-width:0;color:gray;background-color:gray">
                    
                      <dl>
                        <dt><b>A prototype allows the stakeholders to try out the requirements for the system and experience them thereby.</b>
                      </dt>
                      <br>
                        <dd>*Develop the prototype (tool support).
                      </dd>
                      
                      <dd>*Training of the stakeholders.
                      </dd>

                      <dd>*Observation of prototype usage.
                      </dd>
                      <dd>*Collect issues.
                  ...
                  <div class="page-right-2">
                   ...
                   <br>
                      ...
                      <dt><b>Critical Success Factors :</b>
                        ...
                        <dd>*Effort</dd>
                        <dd>*Level of detail of the prototype</dd>
                        <dd>*Quality of the review</dd>
                        <br>
                        <dt><b>Benefit :</b>
                      </dt>
                        <dd>*Highly effective defect detection 
                      </dd>

                      <dd>*Proof of feasibility 
                      </dd>
