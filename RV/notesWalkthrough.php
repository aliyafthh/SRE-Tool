                ...
                <div class="layer-text right">
                  <div class="page-right-2">
                    <div class="page-text w-richtext">
                      ...
                      <h6 id="titledo">WALKTHROUGH</h6>
                     
                      <dl>
                        <dt><b>A walkthrough doesn't have formally defined procedure and doesn't require a differentiated role assignment.</b> 
                      </dt>
<br>
                      <dt>*Checking early whether an idea is feasible or not.
                      </dt>   
                      <br>
                      <dt>*Obtaining the opinion and suggestions of other people.
                      </dt>                
                      <br>
                      <dt>*Checking the approval of others and reaching agreement.
                      </dt> 
                      <br>
                        <dt><b>Critical Success Factors :</b>
                      </dt>
                        <dd>*Involving stakeholders from different contexts.
                      </dd>
                      
                      <dd>*Comprehensible presentation of the artefacts.</dd>
       
                      <dt><b>Benefit :</b>
                      </dt>
                        <dd>*Validation of ideas and sketches.</dd>
