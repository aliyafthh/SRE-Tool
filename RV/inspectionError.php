...
if(isset($_POST['insert']))
{
  ...
  $db = mysqli_select_db($connection, 'sretool');
    ...
    $query = "INSERT INTO inspection2(requirement,error,comment) VALUES ('".$_POST["requirement"]."','".$_POST["error"]."','".$_POST["comment"]."')";
    ...
    if($requirement !='' && $error !='' && $comment !='')
{
//  To redirect form on a particular page
header("Location:previewInsError.php");
}
else{
        ...
        <div class="container-fluid">
          ...
          <div class="card-body shadow-sm p-5">
            ...
            <div class="row">
                <div class="col-md-12">
                <div class="container">  
                    <form id="contact" action="inspectionError.php" method="post">
                        <h3><b>Error(s)</b> Detection</h3>
                        <hr>
                        <fieldset>
                        ...
                        <br>
                        <fieldset>
                        <textarea name = "error" id = "error" placeholder="Error Found :" tabindex="5" required></textarea>
                        </fieldset>
