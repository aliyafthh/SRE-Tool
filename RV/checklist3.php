...
if(isset($_POST['insert']))
{
  ...
  $db = mysqli_select_db($connection, 'sretool');
    ...
    $query = "INSERT INTO checklist3(agreed,changes,resolved) VALUES ('".$_POST["agreed"]."','".$_POST["changes"]."','".$_POST["resolved"]."')";
    ...
    if($agreed !='' && $changes !='' && $resolved !='')
{
//  To redirect form on a particular page
header("Location:previewc3.php");
}
else{
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						<div class="card-body shadow-sm p-5">
							...
							<br>
                            <h2 class="card-title text-info">Validating<b> Agreement</b></h2>
...
<br>
										...
										<form action="checklist3.php" method= "post">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="cardd">
                                                            <div class="card-bodyy">
                                                                <p class="card-description">Have every requirement been agreed by all relevant stakeholders?</p>
                                                                <div> 
                                                                <label> <input type="radio" class="option-input radio" value = "yes" name="agreed" checked /> Yes </label> <br>
                                                                <label> <input type="radio" class="option-input radio" value = "no" name="agreed" /> No </label> 
                                                                </div>
                                                                     <br>
                                                                <p class="card-description">Does every requirement agree by all relevant stakeholders even after it has been changed?</p>
                                                                <div> 
                                                                <label> <input type="radio" class="option-input radio" value = "yes" name="changes" checked /> Yes </label> <br>
                                                                <label> <input type="radio" class="option-input radio" value = "no" name="changes" /> No </label> 
                                                                </div>
                                                                     <br>
                                                                <p class="card-description">Have all identified conflicts about requirements have been resolved?</p>
                                                                <div> 
                                                                <label> <input type="radio" class="option-input radio" value = "yes" name="resolved" checked /> Yes </label> <br>
                                                                <label> <input type="radio" class="option-input radio" value = "no" name="resolved" /> No </label> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <br>
                                                <br>
                                                <button type="submit" name="insert" value="submit" class="btn btn-primary btn btn-block" style='width:490px;margin:0 50%;position:relative;left:-20em;'> Save </button>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <p class="card-description">Find the custom animated radio button for your project</p>
                                                                <div> <label> <input type="radio" class="option-input radio" name="example" checked /> Radio option 1 </label> <label> <input type="radio" class="option-input radio" name="example" /> Radio option 2 </label> <label> <input type="radio" class="option-input radio" name="example" /> Radio option 3 </label> </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> -->
