	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
                ...
                $sql = "SELECT * FROM checklist1 WHERE id=$id";
            ...
            ?>
                     ...
                     <h4 class="card-title bg-info text-light ">Requirement :<b> <?php echo $row['requirement']; ?></b></h4>
<br>
