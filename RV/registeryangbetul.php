...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($studentid_err) && empty($password_err)){
        ...
        $sql = "SELECT  id, studentid, password FROM register WHERE studentid = ?";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $studentid, $hashed_password);
                    ...
                    $studentid_err = "No account found with that ID.";
                }
            } else{
                echo "Oops! Something went wrong. Please try again later.";
            }

            if($studentid !=''&& $password !='') //id....
