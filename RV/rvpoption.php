  ...
  <div class="col-sm-6">
          ...
          <div class="card-container"> 
            <div class="card"><a href="principles.php">
                <div class="card--display"><i class="material-icons">REQUIREMENT VALIDATION PRINCIPLES</i>
                </div>
  ...
  <div class="col-sm-6">
          ...
          <div class="card-container"> 
            <div class="card"><a href="techniques.php">
                <div class="card--display"><i class="material-icons">REQUIREMENT VALIDATION TECHNIQUES</i>
                </div>
                <div class="card--hover">
                  <h2>TECHNIQUES</h2>
                  <p>
